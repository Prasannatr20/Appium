...
//			System.out.println("Unable to save");
		...
		if(search.isDisplayed())
		{
			...
			WebElement input = driver.findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.google.android.dialer:id/open_search_bar_text_view\"]"));
			if(input.isDisplayed())
			{
				input.sendKeys("appium");
